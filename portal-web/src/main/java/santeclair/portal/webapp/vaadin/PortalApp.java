...
public class PortalApp extends UI {
	...
	private EventBus portalAppEventBus = new EventBus();
	...
	public void init(VaadinRequest request) {
		...
		LOGGER.info("Enregistrement du portail au push broadcaster");

		LOGGER.info("Récupération du service OSGi fournisseur des factory de module");
