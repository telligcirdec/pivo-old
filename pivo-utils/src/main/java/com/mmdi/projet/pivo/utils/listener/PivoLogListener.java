...
@Component
public class PivoLogListener implements LogListener {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(PivoLogListener.class);
	private static final Logger LOGGER_OSGI = LoggerFactory
			.getLogger("santeclair.portal.BUNDLE");
	...
	private StringBuffer buildLogMessage(LogEntry entry) {
		...
		if (entry != null) {
			String bundleName = BundleUtils.bundleNameWithVersion(entry
					.getBundle());
