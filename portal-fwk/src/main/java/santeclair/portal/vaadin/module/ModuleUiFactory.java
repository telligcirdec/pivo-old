...
public interface ModuleUiFactory<T extends ModuleUi> extends Serializable {
	 ...
	 */
	Boolean isSeveralModuleAllowed();
	 ...
	 * Si cette méthode renvoi null ou -1 ou 0, l'ordre d'affcihage de ce module
	 * sera réalisé par comparaison du nom du module. Les modules seront
	 * affichés dans l'ordre du plus petit au plus grand nombre puis les modules
	 * ayant une valeur d'ordre à null, -1 ou 0 seront affichés à la suite par
	 * ordre alphabétique. Le comportement par défaut est à priviligier (tri par
	 * ordre alphabétique). Cette notion d'ordre ne doit être implémenté que si
	 * et seulement si un module doit absolument être affiché en premier dans le
	 * menu.
	 * 
	 * @return L'ordre d'affcihage. Null, -1 ou 0 ne déclenche pas de tri sur
	 *         l'ordre mais reste sur le tri par défaut (ordre alphabétique).
	 */
