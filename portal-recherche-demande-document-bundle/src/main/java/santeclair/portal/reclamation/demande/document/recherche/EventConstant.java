...
public interface EventConstant {
    ...
    public static final String EVENT_RECHERCHE_DEMANDE_DOCUMENT_KO = "rechercheKO";
    ...
    public static final String TOPIC_RECHERCHER_DEMANDE_DOCUMENT = "RechercheDemandeDocument";
}
